            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('customer.api-keys.index')" :active="request()->routeIs('customer.api-keys.*')">
                            {{ __('API Keys') }}
                        </x-nav-link>
                        <x-nav-link :href="route('customer.subscriptions.index')" :active="request()->routeIs('customer.subscriptions.*')">
                            {{ __('Subscription') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('customer.api-keys.index')" :active="request()->routeIs('customer.api-keys.*')">
                    {{ __('API Keys') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('customer.subscriptions.index')" :active="request()->routeIs('customer.subscriptions.*')">
                    {{ __('Subscription') }}
                </x-responsive-nav-link>
